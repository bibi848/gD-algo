...
* Kraken_Data: This contains the historical data downloaded from Kraken. This data can be accessed here: Add website link here. Not all data is shown in this repository as the file sizes are too large.
